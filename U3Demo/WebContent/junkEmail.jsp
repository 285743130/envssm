		...
		<div class="action">
			...
			<div class="pages" style="height: 300px">
				<table width="90%" border="0" cellspacing="0" cellpadding="0">
					...
					<td>
					<a href="emailRestore.do?id=${email.id}" style="text-decoration: underline;" onclick="if(confirm('确实执行此操作')) return  true;return false; ">还原</a>
					<a href="deleteEmail.do?id=${email.id}" style="text-decoration: underline;" onclick="if(confirm('确实执行此操作')) return  true;return false; ">删除</a>
					</td>
					</tr>
					</c:forEach>
				</table>
